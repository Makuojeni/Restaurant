...
# Tab 3: Interactive Map
    ...
    if connection:
        # Display map button
        if st.button("🗺️ Display map!", type="primary", help="Map of restaurants in London. Click on teardrop to check names."):
            try:
                # Query location data
                query = """
